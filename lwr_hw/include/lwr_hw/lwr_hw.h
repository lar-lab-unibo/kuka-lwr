...
private:
        ...
        static bool parse(const std::string& urdf_string, std::vector<transmission_interface::TransmissionInfo>& transmissions);
        static bool parseJoints(TiXmlElement *trans_it, std::vector<transmission_interface::JointInfo>& joints);
        static bool parseActuators(TiXmlElement *trans_it, std::vector<transmission_interface::ActuatorInfo>& actuators);
